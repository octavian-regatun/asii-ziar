        ...
        <div className="h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20">
            ...
            <ul>
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <div>
                  ...
                  <a href="https://www.instagram.com/instaasii/?next=%2F">
                    Instagram
                  </a>
                </div>
              </li>
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <div>
                  ...
                  <a href="https://www.linkedin.com/company/asii-asociatia-studentilor-informaticieni-ieseni">
                    Linkedin
                  </a>
                </div>
              </li>
          ...
          <div className="p-5">
            <ul>
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://www.instagram.com/fiipractic/?next=%2F">
                  Fii Practic
                </a>
              </li>
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://www.instagram.com/fiicode/?next=%2F">
                  Fii Code
                </a>
              </li>
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://www.instagram.com/fiiitist/?next=%2F">
                  Fii IT-ist
                </a>
              </li>
            </ul>
          ...
          <div className="p-5">
            <ul>
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://ziar.asii.ro/2022/05/26/balul-bobocilor-fii-2022/">
                  Balul Bobocilor
                </a>
              </li>
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://www.facebook.com/infobachelp/">
                  Info Bac Help
                </a>
              </li>
            </ul>
          ...
          <div className="p-5">
            <ul>
              ...
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://ziar.asii.ro/2021/12/11/parteneri-fii-it-ist/">
                  Parteneri Fii IT-ist
                </a>
              </li>
              <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
                <a href="https://ziar.asii.ro/2021/04/09/partenerii-fii-practic/">
                  Parteneri Fii Practic
                </a>
              </li>
            </ul>
          </div>
